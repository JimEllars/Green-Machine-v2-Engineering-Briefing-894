/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=edge-ledger-worker/wrangler.jsonc edge-ledger-worker/src/worker-configuration.d.ts` (hash: f656d53b5ab2b32cfbe47ac63f6ab9f7)
