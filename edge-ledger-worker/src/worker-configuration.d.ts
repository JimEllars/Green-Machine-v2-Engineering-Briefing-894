/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=edge-ledger-worker/wrangler.jsonc edge-ledger-worker/src/worker-configuration.d.ts` (hash: b286cc8d9c5d968a501e5c0ea190d711)
